...
const SimpleTargetWordsForm = () => {
  ...
  return (
    <>
      <TargetWordsInput addNoun={addNoun} className="w-full sm:w-auto" />
      <div className="relative flex w-[calc(100%-250px)] flex-1 basis-36 items-center gap-1 overflow-hidden px-2">
